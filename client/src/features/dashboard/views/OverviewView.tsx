...
export const OverviewView: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="p-5 border border-border bg-gradient-to-r from-surface to-surface-hover rounded-md shadow-sm relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-brand/20 bg-brand/5 text-xs text-brand font-medium">
          <Sparkles className="w-4 h-4 text-brand animate-pulse" />
          <span>AI Insight: Pipeline is strong, watch integration testing bottlenecks.</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="flex flex-col gap-6 w-full min-w-0">
          ...
          {/* Recent Alerts Feed */}
          <div className="p-5 border border-border bg-surface rounded-md shadow-sm w-full">
            ...
            <ul className="space-y-3">
              <li className="flex items-start justify-between gap-3 text-xs">
                <span className="text-text-primary font-medium break-words leading-tight">WorkOrder #302 overdue status</span>
                <span className="text-[10px] text-danger bg-danger/10 px-1.5 py-0.5 rounded font-semibold shrink-0">Alert</span>
              </li>
              <li className="flex items-start justify-between gap-3 text-xs">
                <span className="text-text-primary font-medium break-words leading-tight">Deal TechCorp changed to Won</span>
                <span className="text-[10px] text-success bg-success/10 px-1.5 py-0.5 rounded font-semibold shrink-0">Update</span>
              </li>
              <li className="flex items-start justify-between gap-3 text-xs">
                <span className="text-text-primary font-medium break-words leading-tight">Workspace sync initiated</span>
                <span className="text-[10px] text-text-secondary bg-border px-1.5 py-0.5 rounded font-semibold shrink-0">System</span>
              </li>
            </ul>
          </div>
        </div>
